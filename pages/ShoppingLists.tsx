    ...
    <div className="px-4 sm:px-6 lg:px-8 pb-24 pt-0 min-h-screen bg-slate-50/50 font-sans">
      ...
      {isOnline && (
        <motion.button 
          ...
          whileTap={{ scale: 0.95 }}
          onClick={handleOpenAddModal}
          className="fixed right-6 bottom-5 md:bottom-8 w-14 h-14 bg-blue-600 text-white rounded-2xl shadow-lg shadow-blue-200 flex items-center justify-center z-50 transition-all duration-300"
        >
