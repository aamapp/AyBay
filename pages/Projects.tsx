    ...
    <div className="space-y-4">
      ...
      {isOnline && (
        <button
          ...
          className="fixed right-6 bottom-5 md:bottom-8 z-50 bg-indigo-600 text-white w-14 h-14 rounded-full flex items-center justify-center shadow-2xl active:scale-95 transition-all duration-300 md:right-8 hover:bg-indigo-700"
